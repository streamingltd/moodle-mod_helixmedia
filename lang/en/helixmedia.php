...
$string['bad_referer'] = 'Launch blocked: MEDIAL launches  must be initiated by other pages within your Moodle.';
...
$string['invalid_launch_data'] = 'Error: This MEDIAL resource is of the wrong type to be embedded here.';
...
$string['no_direct_launch'] = 'Launch blocked: Embedded MEDIAL resources cannot be launched directly.';
...
$string['protectreferer'] = 'Enable referer URL protection for launches';
$string['protectreferer_help'] = 'This will block calls to the launch page that were not initiated by some other page in the Moodle installation. Disable this if you have direct links to the launch page outside of your Moodle installation for some reason. Direct launch links are not reccomended.';
