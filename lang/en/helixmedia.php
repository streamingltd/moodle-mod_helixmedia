...
$string['privacy:metadata:helixmedia_mobile'] = 'Helixmedia database for mobile support.';
$string['privacy:metadata:helixmedia_mobile:userid'] = 'The userid of the mobile user';
